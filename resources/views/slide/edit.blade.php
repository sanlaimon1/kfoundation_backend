            ...
            <section class="row frame">
                <div class="row">
                    <div class="mb-3">
                        ...
                        @enderror
                        <input type="text" class="form-control" id="title" name="title" placeholder="标题" value="{{$slide->title}}">
                    </div>
                </div>
                <div class="row">
                    <div class="mb-3">
                        ...
                        @error('link')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <input type="text" class="form-control" id="link" name="link" placeholder="超链接" value="{{$slide->link}}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select id="type" name="type"  class="form-select" >
                            <option value="1" @if($slide->type == 1) selected @endif>轮播</option>
                            <option value="0" @if($slide->type == 0) selected @endif>图库</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select id="status" name="status"  class="form-select" >
                            <option value="1" @if($slide->status == 1) selected @endif>显示</option>
                            <option value="0" @if($slide->status == 0) selected @endif>隐藏</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        @error('sort')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <input type="text" class="form-control" name="sort" id="sort" placeholder="排序" value="{{$slide->sort}}">
                    </div>
                </div>
