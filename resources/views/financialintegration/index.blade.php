...
<body>
    <div class="container-fluid">
        ...
        <nav class="row">
            <div class="col-3">
                ...
                <input type="text" name="financialintegration_id" id="financialintegration_id" class="form-control" />
            </div>
            ...
            <div class="col-1">
                <br />
                <button class="btn btn-success" id="integration_search">查询</button>
            </div>
        </nav>
        <br />
        ...
        <div class="container-fluid">
            ...
            <div class="box2 p-2">
            <form method="get" action="{{ route('integration.index') }}">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#integration_search").click(function(){
            var financialintegration_id = $("#financialintegration_id").val();
            var customer = $("#customer").val();
            var financial_type = $("#financial_type").val();
            var date = $("#date").val();
            var data = {
                "financialintegration_id": financialintegration_id,
                "customer": customer,
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $.each(response.integration_search ,function(i,v){
                        console.log(v);
