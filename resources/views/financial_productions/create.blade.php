    ...
    <div id="app" class="container-fluid">
        <nav id="nav" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">创建交易所商品</li>
            </ol>
        </nav>

        <form action="{{ route('financial_productions.store') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <section class="row frame">
                <div class="row p-3">
                    <div class="mb-3 col-6">
                        ...
                        @enderror
                        <input type="text" class="form-control " id="production_name" name="production_name" placeholder="产品名称" value="">
                    </div>
                    <div class="mb-3 col-6">
                ...
                <div class="row p-3">
                    <div class="mb-3 col-6">
                        ...
                        @error('buy_price')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <input type="number" step="any" class="form-control" id="buy_price" name="buy_price" placeholder="买入价格" value="">
                    </div>
                    <div class="mb-3 col-6">
                        ...
                        @error('sell_price')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <input type="number" step="any" class="form-control" id="sell_price" name="sell_price" placeholder="卖出价格" value="">
                    </div>
                </div>
                <div class="row p-3">
                    <div class="mb-3 col-6">
                ...
                <div class="row p-3">
                    ...
                    <div class="mb-3 col-6">
                        ...
                        @error('fee')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <input type="number" step="any" class="form-control" id="fee" name="fee" placeholder="0.00" value="">
                    </div>
                </div>
                <div class="row p-3">
                    <div class="mb-3 col-6">
                        ...
                        @error('max_times')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <input type="number" class="form-control" id="max_times" name="max_times" placeholder="最大投资次数" value="">
                    </div>
                    <div class="mb-3 col-6">
                        ...
                        @error('fake_process')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <input type="number" step="any" class="form-control" id="fake_process" name="fake_process" placeholder="0.00" value="">
                    </div>
                </div>
                <div class="row p-3">
                    <div class="mb-3 col-6">
                        ...
                        @error('increment_process')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <input type="text" class="form-control" id="increment_process" name="increment_process" placeholder="0.00" value="">
                    </div>
                    <div class="mb-3 col-6">
                ...
                <div class="row p-3">
                    <div class="mb-3 col-6">
                        ...
                        <img id="show-picture" src="#" width="120" height="120" />
