...
<body>
    <div id="app" class="container-fluid">
        <nav id="nav" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('charge.index') }}">资产充值申请列表</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">拒绝充值</li>
            </ol>
        </nav>
        ...
        <form action="{{ route('charge.destroy',['charge'=>$one->id]) }}" method="post">
            {{ csrf_field() }}
            @method('DELETE')
            ...
            <a class="btn btn-secondary" href="{{ route('charge.index') }}" style="margin-top:1rem; margin-right:1rem; float:right;">取消</a>
        </form>
